...
У вас есть внутренние документы, которые не должны находиться в вашем публичном GitHub-репозитории. Но ваш ИИ-агент не может помочь вам как следует, если не может их прочитать — он выдумывает требования и игнорирует ограничения, которые вы уже задокументировали.

Умножьте это на несколько проектов и несколько агентов. У каждого своя конфигурация. При каждом переключении контекст теряется. И нет стандартного способа организовать или проверить всё это.
